    ...
    <div>
        <div className="container-fluid fh5co_header_bg">
            <div className="container">
                <div className="row">
                    <div className="col-12 fh5co_mediya_center"><a href="#" className="color_fff fh5co_mediya_setting"><i
                                className="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;Friday, 5 January 2018</a>
                        <div className="d-inline-block fh5co_trading_posotion_relative"><a href="#"
                                className="treding_btn">Trending</a>
                            <div className="fh5co_treding_position_absolute"></div>
                        </div>
                        <a href="#" className="color_fff fh5co_mediya_setting">Instagram’s big redesign goes live with
                    ...
                    <div className="col-12 col-md-9 align-self-center fh5co_mediya_right">
                        <div className="text-center d-inline-block">
                            <a className="fh5co_display_table">
                                <div className="fh5co_verticle_middle"><i className="fa fa-search"></i></div>
                            </a>
                        </div>
                        <div className="text-center d-inline-block">
                            <a className="fh5co_display_table">
                        ...
                        <div className="text-center d-inline-block">
                            <a href="https://fb.com/fh5co" target="_blank" className="fh5co_display_table">
                ...
                <nav className="navbar navbar-toggleable-md navbar-light ">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto">
                            ...
                            <li className="nav-item ">
                                <a className="nav-link" href="Contact_us.html">Contact <span
                                        className="sr-only">(current)</span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="row mx-0">
                    <div className="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                        <p>
                            ...
                            justo risus et nunc. Donec quis justo nec diam hendrerit facilisis placerat non magna. className
                            aptent
                    ...
                    <div className="col-md-3 animate-box" data-animate-effect="fadeInRight">
                        ...
                        <div className="row pb-3">
                            ...
                            <div className="col-7 paddding">
                                <div className="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.
                                </div>
                        ...
                        <div className="row pb-3">
                            ...
                            <div className="col-7 paddding">
                                <div className="most_fh5co_treding_font"> Enim ad minim veniam nostrud xercitation ullamco.
                                </div>
                                <div className="most_fh5co_treding_font_123"> April 18, 2016</div>
                            </div>
                        </div>
                        ...
                        <div className="row pb-3">
                            <div className="col-5 align-self-center"><img src="images/seth-doyle-133175.jpg" alt="img"
                                    className="fh5co_most_trading" /></div>
                            <div className="col-7 paddding">
                                <div className="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.
                                </div>
                                <div className="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div className="owl-carousel owl-theme" id="slider2">
                    <div className="item px-2">
                        <div className="fh5co_hover_news_img">
                            ...
                            <div>
                                <a href="#" className="d-block fh5co_small_post_heading"><span className="">The top 10 best computer
        ...
        <div className="container-fluid fh5co_footer_bg pb-3">
            <div className="container animate-box">
                <div className="row">
                    <div className="col-12 spdp_right py-5"><img src="images/white_logo.png" alt="img" className="footer_logo" />
                    </div>
                    <div className="clearfix"></div>
                    ...
                    <div className="col-12 col-md-5 col-lg-3 position_footer_relative">
                        ...
                        <div className="footer_makes_sub_font"> Dec 31, 2016</div>
                        <a href="#" className="footer_post pb-4"> Success is not a good teacher failure makes you humble </a>
                        <div className="footer_position_absolute"><img src="images/footer_sub_tipik.png" alt="img"
                                className="width_footer_sub_img" /></div>
                    </div>
                ...
                <div className="row justify-content-center pt-2 pb-4">
                    <div className="col-12 col-md-8 col-lg-7 ">
                        <div className="input-group">
                            <span className="input-group-addon fh5co_footer_text_box" id="basic-addon1"><i
                                    className="fa fa-envelope"></i></span>
                            <input type="text" className="form-control fh5co_footer_text_box" placeholder="Enter your email..."
                                aria-describedby="basic-addon1"/>
                            <a href="#" className="input-group-addon fh5co_footer_subcribe" id="basic-addon12"> <i
                                    className="fa fa-paper-plane-o"></i>&nbsp;&nbsp;Subscribe</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="container-fluid fh5co_footer_right_reserved">
            <div className="container">
                <div className="row  ">
                    <div className="col-12 col-md-6 py-4 Reserved"> © Copyright 2018, All rights reserved. Design by <a
